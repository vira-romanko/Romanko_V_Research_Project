...
export default {
  ...
  <div>
    ...
    <div class="d-block">When you were here before
    ...
    You're so fuckin' special</div>
    <div class="d-block p-2">But I'm a creep
    I'm a weirdo
    What the hell am I doing here?
    I don't belong here</div>
   <div class="d-block p-2"> I don't care if it hurts
    ...
    I wish I was special</div>
    <div class="d-block">But I'm a creep
    I'm a weirdo
    What the hell am I doing here?
    I don't belong here, oh, oh</div>
    <div class="d-block p-2">She's running out the door
    She's running out
    She run, run, run, run
    Run
    ...
    I don't belong here
      ...
      <div  id='rg_embed_link_109096' class='rg_embed_link link' data-song-id='109096'>Read <a  href='https://genius.com/Radiohead-creep-lyrics'>“Creep” by Radiohead</a> on Genius</div>
          ...
          tracks: [
            {
              name: "Creep",
              artist: "Radiohead",
              cover:"images/radiohead.jpg",
              source: "audio/radiohead.mp3",
              url: "https://www.youtube.com/watch?v=XFkzRNyygfk&list=PL67y-alyKlu8bUAIcHOiMYpj20l6HUYJZ",
              favorited: false
            }
